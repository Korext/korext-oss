...
export const metadata = buildMetadata({
  ...
  path: '/incidents',
  tags: ['AI incidents', 'AI code failures', 'incident registry', 'AI safety', 'code regression'],
});
    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/incidents/submit" className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-semibold transition-all text-sm sm:text-base">
              Report an Incident
            </Link>
            <Link href="/incidents/browse" className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-white font-semibold transition-all border border-white/[0.06] text-sm sm:text-base">
              Browse Registry
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 border-b border-white/[0.06]">
        <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
          ...
          <div className="p-8 sm:p-12 bg-white/[0.02] border border-white/[0.06] rounded-2xl text-center">
      ...
      <section className="py-12 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            <div className="p-6 sm:p-10 bg-white/[0.02] border border-white/[0.06] rounded-2xl space-y-4">
